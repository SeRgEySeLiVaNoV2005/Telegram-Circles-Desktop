...
from PyQt6.QtCore import Qt, QRect, pyqtSignal, QSize, QPoint
from PyQt6.QtGui import QPainter, QColor, QRegion, QPen
...
class CircleUI(QWidget):
    ...
    def get_capture_rect(self):
        """Возвращает область для захвата с коррекцией DPI"""
    ...
    def paintEvent(self, event):
        ...
        c_rect = QRect(self.center.x() - self.circle_size // 2, self.center.y() - self.circle_size // 2,
